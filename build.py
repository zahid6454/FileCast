...
def render_all_pages(
    ...
    # listed id (static/videos/<id>-demo.mp4) plus a branded poster image
    # (static/videos/<id>-demo-poster.jpg, generated by
    # scripts/generate_demo_posters.js — not a video frame or a page capture;
    # see home.html's #demo-carousel-data). Adding a 7th demo means adding it
    # to that script's TOOLS list, regenerating the poster, and adding the id
    # here; a listed id missing either file would 404 (the video) or silently
    # show no poster while it loads, so this only grows in step with
    # static/videos/.
    demo_tool_ids = [
        "docx-to-pdf",
        "csv-to-json",
