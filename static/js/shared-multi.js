  ...
  function startConversion() {
    ...
    if (hasBatch) {
      ...
      Promise.resolve()
        ...
        .catch(function (err) {
          if (cancelledThisRun) return;
          var msg = FC.errorMessage(err, 'Processing failed. One or more files may be corrupted.');
