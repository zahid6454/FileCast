...
// since this worker's script URL is hashed by the build's asset pipeline
// (see templates/base.html's assets.get()), so there is no stable path to
// importScripts() it from here. A converter throws a plain Error for an
// expected input-validation rejection (or, in one edge case elsewhere in
// this codebase, a bare descriptive string); anything else is an
// unanticipated crash.
