...
<div class="stat-strip">
  ...
  <div class="stat-tile">
    ...
    <span class="stat-tile__label">Structured JSON output</span>
    <span class="stat-tile__sub">An array of objects, ready to use</span>
  </div>
  <div class="stat-tile">
    ...
    <span class="stat-tile__sub">First row becomes each object's keys</span>
  </div>
</div>
