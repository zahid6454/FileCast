...
describe('bmp-to-jpg.js — window.convertFile', () => {
  it('fills a white background then draws the image and exports JPEG', async () => {
    ...
    // BMP has no alpha but JPEG output needs an opaque canvas regardless of
    // source format — this converter always fills white before drawing.
