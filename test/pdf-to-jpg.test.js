  ...
  return `
    ...
    <div id="result" class="hidden">
      ...
      <div class="result__actions">
        <button class="btn btn--success" id="download-btn">Download JPG</button>
...
describe('pdf-to-jpg.js — window.convertFile', () => {
  it('renders a single-page PDF straight to a JPEG blob, no multi-page UI takeover', async () => {
    const dom = createDom();
    mockPdfjsLib(dom.window, { numPages: 1 });
    const { toBlobCalls } = mockCanvas(dom.window);
    evalScript(dom, 'converters/pdf-to-jpg.js');
